...
export default function AdminMcpPage() {
  ...
  return (
    <PageLayout>
      <PageHeader
        title="Admin MCP"
        description="Use AI models with tool calling to manage projects and query global statistics. Supports OpenAI, LM Studio, and Ollama."
      />
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-muted-foreground">
                ...
                <p className="text-base">
                  Start a conversation to manage your projects with AI
                </p>
                <p className="text-sm mt-2">
                  Try: &quot;List all projects&quot; or &quot;Create a new project
                  called MyApp&quot;
                </p>
              </div>
            ) : (
