...
describe("DatabaseService", () => {
  ...
  beforeEach(() => {
    ...
    jest.doMock("../../services/database", () => database);
  });
  ...
  describe("User Management", () => {
    ...
    describe("getUserByUsername", () => {
      it("should return user when found", () => {
        ...
        const result = database.getUserByUsername("testuser");
      ...
      it("should return undefined when user not found", () => {
        ...
        const result = database.getUserByUsername("nonexistent");
    ...
    describe("updateUser", () => {
      it("should update user successfully", () => {
        ...
        const result = database.updateUser(1, {
          email: "newemail@example.com",
        });
    ...
    describe("deleteUser", () => {
      it("should delete user successfully", () => {
        ...
        const result = database.deleteUser(1);
  ...
  describe("Content Management", () => {
    ...
    describe("getContentByKey", () => {
      it("should return content when found", () => {
        ...
        const result = database.getContentByKey("test-content");
    ...
    describe("getAllContent", () => {
      it("should return all content", () => {
        ...
        const result = database.getAllContent();
    ...
    describe("updateContent", () => {
      it("should update content successfully", () => {
        ...
        const result = database.updateContent("1", {
          data: { title: "Updated", body: "Updated content" },
        });
    ...
    describe("deleteContent", () => {
      it("should delete content successfully", () => {
        ...
        const result = database.deleteContent("1");
  ...
  describe("File Management", () => {
    ...
    describe("createFile", () => {
      it("should create file record successfully", () => {
        ...
        const result = database.createFile({
          filename: "test.txt",
          original_name: "test.txt",
          mime_type: "text/plain",
          size: 1024,
  ...
  describe("Search Functionality", () => {
    it("should perform search across content", () => {
      ...
      const result = database.search("test", 50);
  ...
  describe("Database Operations", () => {
    ...
    describe("Performance", () => {
      it("should handle large datasets efficiently", () => {
        ...
        const largeDataset = Array(1000).fill(mockContentData);
