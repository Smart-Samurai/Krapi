...
const createTestApp = () => {
  ...
  app.get("/api/stats", ApiManagementController.getApiStats);
  app.get("/api/keys", ApiManagementController.getApiKeys);
  app.post("/api/keys", ApiManagementController.createApiKey);
  app.put("/api/keys/:id", ApiManagementController.updateApiKey);
  app.patch("/api/keys/:id/toggle", ApiManagementController.toggleApiKey);
  app.delete("/api/keys/:id", ApiManagementController.deleteApiKey);
  app.get("/api/endpoints", ApiManagementController.getApiEndpoints);
  app.get("/api/rate-limits", ApiManagementController.getRateLimits);
...
describe("ApiManagementController", () => {
  ...
  describe("GET /api/stats", () => {
    it("should return API statistics successfully", async () => {
      ...
      mockDatabase.getApiKeys.mockReturnValue([
        ...
        { id: "2", active: true } as any,
        { id: "3", active: false } as any,
      ]);
  ...
  describe("GET /api/keys", () => {
    it("should return all API keys successfully", async () => {
      ...
      const response = await request(app).get("/api/keys").expect(200);
    ...
    it("should handle database errors", async () => {
      ...
      const response = await request(app).get("/api/keys").expect(500);
  ...
  describe("POST /api/keys", () => {
    ...
    it("should validate required fields", async () => {
      ...
      expect(response.body.error).toBe(
        "Name, permissions, and rate_limit are required"
      );
    });
    ...
    it("should handle single permission as string", async () => {
      ...
      mockDatabase.createApiKey.mockReturnValue(mockCreatedKey as any);
  ...
  describe("PUT /api/keys/:id", () => {
    it("should update an existing API key successfully", async () => {
      ...
      mockDatabase.getApiKeyById.mockReturnValue(existingKey as any);
      mockDatabase.updateApiKey.mockReturnValue(updatedKey as any);
      ...
      expect(mockDatabase.updateApiKey).toHaveBeenCalledWith(
        "key-1",
        updateData
      );
    });
  ...
  describe("PATCH /api/keys/:id/toggle", () => {
    it("should toggle API key status successfully", async () => {
      ...
      mockDatabase.getApiKeyById.mockReturnValue(existingKey as any);
      mockDatabase.updateApiKey.mockReturnValue(toggledKey as any);
  ...
  describe("DELETE /api/keys/:id", () => {
    it("should delete API key successfully", async () => {
      ...
      const response = await request(app).delete("/api/keys/key-1").expect(200);
    ...
    it("should handle deletion failures", async () => {
      ...
      const response = await request(app).delete("/api/keys/key-1").expect(500);
  ...
  describe("GET /api/endpoints", () => {
    ...
    it("should handle database errors", async () => {
      ...
      const response = await request(app).get("/api/endpoints").expect(500);
  ...
  describe("GET /api/rate-limits", () => {
    it("should return rate limits successfully", async () => {
      ...
      const response = await request(app).get("/api/rate-limits").expect(200);
    ...
    it("should handle database errors", async () => {
      ...
      const response = await request(app).get("/api/rate-limits").expect(500);
  ...
  describe("Error Handling", () => {
    ...
    it("should handle very large request bodies", async () => {
      ...
      const response = await request(app).post("/api/keys").send(largeData);
  ...
  describe("Input Validation", () => {
    it("should handle special characters in API key names", async () => {
      ...
      mockDatabase.createApiKey.mockReturnValue({ id: "test" } as any);
