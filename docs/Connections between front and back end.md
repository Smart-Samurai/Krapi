...
12. [MCP & AI Integration](#mcp--ai-integration)
...
- **Frontend**: `admin-frontend/lib/api.ts` - `emailAPI.getEmailConfiguration()`
- **Backend**: `api-server/src/controllers/email.ts` - `EmailController.getEmailConfiguration()`

### Update Email Configuration
- **Endpoint**: `PUT /api/admin/email/config`
- **Frontend**: `admin-frontend/lib/api.ts` - `emailAPI.updateEmailConfiguration()`
- **Backend**: `api-server/src/controllers/email.ts` - `EmailController.updateEmailConfiguration()`
...
- **Frontend**: `admin-frontend/lib/api.ts` - `emailAPI.testEmailConnection()`
- **Backend**: `api-server/src/controllers/email.ts` - `EmailController.testEmailConnection()`

### Send Email
- **Endpoint**: `POST /api/admin/email/send`
- **Frontend**: `admin-frontend/lib/api.ts` - `emailAPI.sendEmail()`
- **Backend**: `api-server/src/controllers/email.ts` - `EmailController.sendEmail()`
...
- **Frontend**: `admin-frontend/lib/api.ts` - `emailAPI.getAllTemplates()`
- **Backend**: `api-server/src/controllers/email.ts` - `EmailController.getAllTemplates()`

### Create Email Template
- **Endpoint**: `POST /api/admin/email/templates`
- **Frontend**: `admin-frontend/lib/api.ts` - `emailAPI.createTemplate()`
- **Backend**: `api-server/src/controllers/email.ts` - `EmailController.createTemplate()`
...
- **Frontend**: `admin-frontend/lib/api.ts` - `emailAPI.updateTemplate()`
- **Backend**: `api-server/src/controllers/email.ts` - `EmailController.updateTemplate()`

### Delete Email Template
- **Endpoint**: `DELETE /api/admin/email/templates/:id`
- **Frontend**: `admin-frontend/lib/api.ts` - `emailAPI.deleteTemplate()`
- **Backend**: `api-server/src/controllers/email.ts` - `EmailController.deleteTemplate()`

### Get Email Logs
- **Endpoint**: `GET /api/admin/email/logs`
- **Frontend**: `admin-frontend/lib/api.ts` - `emailAPI.getEmailLogs()`
- **Backend**: `api-server/src/controllers/email.ts` - `EmailController.getEmailLogs()`

### Get Email Stats
- **Endpoint**: `GET /api/admin/email/stats`
- **Frontend**: `admin-frontend/lib/api.ts` - `emailAPI.getEmailStats()`
- **Backend**: `api-server/src/controllers/email.ts` - `EmailController.getEmailStats()`
