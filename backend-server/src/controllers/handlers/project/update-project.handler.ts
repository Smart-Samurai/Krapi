 ...
 * 
 * Uses SDK projects.updateProject() method for consistent architecture.
 */
export class UpdateProjectHandler {
  ...
  async handle(req: Request, res: Response): Promise<void> {
    try {
      ...
      // Use SDK projects.updateProject() method
      const updatedProject = await this.backendSDK.projects.updateProject(sanitizedId, updates);
